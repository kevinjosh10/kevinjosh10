...
svg_content = """<svg width="800" height="250" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <radialGradient id="puffBright">
      ...
      <stop offset="70%" stop-color="#cbd5e1" stop-opacity="0.95"  />
      <stop offset="90%" stop-color="#94a3b8" stop-opacity="0.6" />
    ...
    <radialGradient id="puffMid">
      ...
      <stop offset="75%" stop-color="#64748b" stop-opacity="0.95"  />
      <stop offset="95%" stop-color="#475569" stop-opacity="0.5" />
    ...
    <radialGradient id="puffDark">
      ...
      <stop offset="95%" stop-color="#1e293b" stop-opacity="0.6"  />
    ...
    <radialGradient id="puffDeep">
      ...
      <stop offset="80%" stop-color="#0f172a" stop-opacity="0.9"  />
    ...
    <radialGradient id="puffWhite">
      ...
      <stop offset="60%" stop-color="#f8fafc" stop-opacity="0.8" />
      <stop offset="90%" stop-color="#e2e8f0" stop-opacity="0.4" />
