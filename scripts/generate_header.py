...
svg_content = """<svg width="800" height="250" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <!-- Animated Glitter / Shine Gradient -->
    <linearGradient id="shine" x1="-20%" y1="0%" x2="0%" y2="0%">
      <stop offset="0%" stop-color="#ffffff" stop-opacity="0" />
      <stop offset="50%" stop-color="#ffffff" stop-opacity="0.9" />
      <stop offset="100%" stop-color="#ffffff" stop-opacity="0" />
      <!-- Sweeps across then pauses before repeating -->
      <animate attributeName="x1" values="-20%; 120%; 120%" dur="4s" repeatCount="indefinite" />
      <animate attributeName="x2" values="0%; 140%; 140%" dur="4s" repeatCount="indefinite" />
    </linearGradient>
  ...
  <!-- Text Overlay Shine Layer (Exact same text, filled with sweeping gradient) -->
  <text x="50%" y="80" class="title" fill="url(#shine)" filter="none">Hello, World! I'm Kevin 👨‍💻</text>
  <text x="50%" y="125" class="sub1" fill="url(#shine)" filter="none">I push directly to main.</text>
</svg>
"""
