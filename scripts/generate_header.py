...
svg_content = """<svg width="800" height="250" xmlns="http://www.w3.org/2000/svg">
  ...
  <g class="finalReveal">
    ...
    <text x="46%" y="80" class="title">Hello, World! I'm Kevin</text>
      ...
      <rect x="652" y="50" width="26" height="10" rx="2" fill="none" stroke="#00f2fe" stroke-width="1.5" filter="url(#neonGlow)" />
      <line x1="656" y1="55" x2="662" y2="55" stroke="#00f2fe" stroke-width="1.5" filter="url(#neonGlow)" />
      <circle cx="672" cy="55" r="1.5" fill="#39ff14" class="neonBlink2" filter="url(#neonGlow)" />
